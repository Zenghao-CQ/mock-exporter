...
var (
	...
	metricsNamespace = flag.String("metric.namespace", "dev", "Prometheus metrics namespace, as the prefix of metrics name")
	start            = flag.Int64("start", 5, "base of random time")
	period           = flag.Int64("period", 10, "period of random time")
